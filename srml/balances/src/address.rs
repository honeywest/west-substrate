...
use super::{As, Decode, Encode, Input, Member, Output};
#[cfg(feature = "std")]
use std::fmt;
...
where
    ...
    AccountIndex:
        Member + Decode + PartialOrd<AccountIndex> + Ord + As<u32> + As<u16> + As<u8> + Copy,
{
...
where
    ...
    AccountIndex:
        Member + Encode + PartialOrd<AccountIndex> + Ord + As<u32> + As<u16> + As<u8> + Copy,
{
