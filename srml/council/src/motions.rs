...
mod tests {
    ...
    use tests::*;
    use tests::{Call, Event as OuterEvent, Origin};
            ...
            assert_eq!(
                ...
                vec![EventRecord {
                    ...
                    event: OuterEvent::motions(RawEvent::Proposed(
                        1,
                        0,
                        hex!["35282aeb9f95795dc1be91b748cec2d210338f2c9c1a85d98e7a3619b6187d22"]
                            .into(),
                        3
                    ))
                }]
    ...
    fn motions_ignoring_non_council_proposals_works() {
        with_externalities(&mut new_test_ext(true), || {
            ...
            let proposal = set_balance_proposal(42);
            assert_noop!(
                CouncilMotions::propose(Origin::signed(42), 3.into(), Box::new(proposal.clone())),
    ...
    fn motions_ignoring_non_council_votes_works() {
        with_externalities(&mut new_test_ext(true), || {
            ...
            assert_noop!(
                CouncilMotions::vote(Origin::signed(42), hash.clone(), 0.into(), true),
    ...
    fn motions_ignoring_bad_index_council_vote_works() {
        with_externalities(&mut new_test_ext(true), || {
            ...
            assert_noop!(
                CouncilMotions::vote(Origin::signed(2), hash.clone(), 1.into(), true),
                "mismatched index"
            );
        });
    }
    ...
    fn motions_revoting_works() {
        with_externalities(&mut new_test_ext(true), || {
            ...
            assert_noop!(
                CouncilMotions::vote(Origin::signed(1), hash.clone(), 0.into(), true),
            ...
            assert_noop!(
                CouncilMotions::vote(Origin::signed(1), hash.clone(), 0.into(), false),
                "duplicate vote ignored"
            );
                ...
                vec![
                    EventRecord {
                        ...
                        event: OuterEvent::motions(RawEvent::Proposed(
                            ...
                            0,
                            hex![
                                "35282aeb9f95795dc1be91b748cec2d210338f2c9c1a85d98e7a3619b6187d22"
                            ]
                            .into(),
                            2
                        ))
