...
pub use srml_metadata::{DecodeDifferent, FnEncode, RuntimeMetadata, RuntimeModuleMetadata};
...
mod tests {
    ...
    use srml_metadata::{
        CallMetadata, EventMetadata, FunctionMetadata, ModuleMetadata, OuterDispatchCall,
        OuterDispatchMetadata, OuterEventMetadata, RuntimeModuleMetadata, StorageFunctionMetadata,
    ...
    const EXPECTED_METADATA: RuntimeMetadata = RuntimeMetadata {
        ...
        modules: DecodeDifferent::Encode(&[
            RuntimeModuleMetadata {
                ...
                module: DecodeDifferent::Encode(FnEncode(|| ModuleMetadata {
                    name: DecodeDifferent::Encode("Module"),
                    call: CallMetadata {
                        name: DecodeDifferent::Encode("Call"),
                        functions: DecodeDifferent::Encode(&[FunctionMetadata {
                            id: 0,
            ...
            RuntimeModuleMetadata {
                ...
                storage: Some(DecodeDifferent::Encode(FnEncode(|| StorageMetadata {
                    ...
                    functions: DecodeDifferent::Encode(&[StorageFunctionMetadata {
