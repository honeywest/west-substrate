...
use codec::Encode;
use hash_db::Hasher;
use primitives::{convert_hash, Blake2Hasher, H256};
...
use state_machine::{
    ...
    Backend as StateBackend, CodeExecutor, ExecutionManager, OverlayedChanges,
};
    ...
    E: CallExecutor<Block, Blake2Hasher>,
{
    let trie_state = state.try_into_trie_backend().ok_or_else(|| {
        Box::new(state_machine::ExecutionError::UnableToGenerateProof) as Box<state_machine::Error>
    })?;
...
mod tests {
    ...
    fn execution_proof_is_generated_and_checked() {
        ...
        fn execute(
            ...
            let local_result = check_execution_proof(
                &local_executor,
                &RemoteCallRequest {
