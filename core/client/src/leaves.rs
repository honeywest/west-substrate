...
impl<H, N> Ord for LeafSetItem<H, N>
where
    N: Ord,
{
...
impl<H, N> PartialOrd for LeafSetItem<H, N>
where
    N: PartialOrd,
{
...
impl<H, N> PartialEq for LeafSetItem<H, N>
where
    N: PartialEq,
{
...
mod tests {
    ...
    fn it_works() {
        ...
        assert!(set.storage.contains(&LeafSetItem {
            hash: 3_1,
            number: 3
        }));
        assert!(!set.storage.contains(&LeafSetItem {
