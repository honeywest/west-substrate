...
use state_machine::{
    self, native_when_possible, CodeExecutor, ExecutionManager, Ext, OverlayedChanges,
};
use std::cmp::Ord;
use std::sync::Arc;
use trie::MemoryDB;
    ...
    Block: BlockT<Hash = H256>,
{
        ...
        ExecutionManager<EM>: Clone,
    {
        ...
        self.call_at_state(&state, changes, method, call_data, manager)
            .map(|cr| cr.0)
    }
    ...
    fn runtime_version(&self, id: &BlockId<Block>) -> error::Result<RuntimeVersion> {
        ...
        self.executor
            .runtime_version(&mut ext, heap_pages, &code)
