...
pub struct BlockBuilder<'a, Block, InherentData, A: ProvideRuntimeApi>
where
    Block: BlockT,
{
    ...
    A::Api: BlockBuilderApi<Block, InherentData>,
{
    ...
    pub fn push(&mut self, xt: <Block as BlockT>::Extrinsic) -> error::Result<()> {
        ...
        where
            T: BlockBuilderApi<Block, InherentData>,
        {
            api.map_api_result(|api| match api.apply_extrinsic(block_id, &xt)? {
