...
pub use runtime_primitives::{
    generic::BlockId,
    traits::{ApiRef, Block as BlockT, GetNodeBlockType, GetRuntimeBlockType, RuntimeApiInfo},
...
pub trait ConstructRuntimeApi<Block: BlockT> {
    ...
    fn construct_runtime_api<'a, T: CallRuntimeAt<Block>>(call: &'a T) -> ApiRef<'a, Self>
    where
        Self: Sized;
}
