...
pub fn delta_trie_root<H: Hasher, I, A, B>(
    db: &mut HashDB<H>,
    mut root: H::Out,
    delta: I,
...
pub fn read_trie_value<H: Hasher>(
    db: &HashDB<H>,
    root: &H::Out,
    key: &[u8],
...
pub fn read_trie_value_with<H: Hasher, Q: Query<H, Item = DBValue>>(
    db: &HashDB<H>,
    root: &H::Out,
    key: &[u8],
    query: Q,
...
pub fn child_delta_trie_root<H: Hasher, I, A, B>(
    _storage_key: &[u8],
    db: &mut HashDB<H>,
    root_vec: Vec<u8>,
    delta: I,
...
pub fn for_keys_in_child_trie<H: Hasher, F: FnMut(&[u8])>(
    _storage_key: &[u8],
    db: &HashDB<H>,
    root_slice: &[u8],
    mut f: F,
...
pub fn record_all_keys<H: Hasher>(
    db: &HashDB<H>,
    root: &H::Out,
...
pub fn read_child_trie_value<H: Hasher>(
    _storage_key: &[u8],
    db: &HashDB<H>,
    root_slice: &[u8],
    key: &[u8],
...
pub fn read_child_trie_value_with<H: Hasher, Q: Query<H, Item = DBValue>>(
    _storage_key: &[u8],
    db: &HashDB<H>,
    root_slice: &[u8],
    key: &[u8],
