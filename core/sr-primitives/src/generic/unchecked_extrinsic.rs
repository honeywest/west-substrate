...
use codec::{Codec, Decode, Encode, HasCompact, Input};
use rstd::prelude::*;
use traits::{self, Extrinsic, Lookup, MaybeDisplay, Member, SimpleArithmetic};
...
impl<Address: Codec, Index: HasCompact + Codec, Signature: Codec, Call> Extrinsic
    for UncheckedExtrinsic<Address, Index, Call, Signature>
{
