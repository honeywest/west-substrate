...
impl CheckInherentError {
    ...
    pub fn combine_results<F: FnOnce() -> Result<(), Self>>(
        this: Result<(), Self>,
        other: F,
    ) -> Result<(), Self> {
        match this {
...
#[cfg(test)]
mod tests {
    use codec::{Decode as DecodeHidden, Encode as EncodeHidden};
    ...
    fn impl_outer_log_works() {
        ...
        let generic_b1: super::generic::DigestItem<H256, u64> =
            DecodeHidden::decode(&mut &encoded_b1[..]).unwrap();
        match generic_b1 {
        ...
        let generic_auth_change: super::generic::DigestItem<H256, u64> =
            DecodeHidden::decode(&mut &encoded_auth_change[..]).unwrap();
        match generic_auth_change {
            super::generic::DigestItem::AuthoritiesChange::<H256, u64>(authorities) => {
