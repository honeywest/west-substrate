...
use changes_trie::{Configuration as ChangesTrieConfig, NO_EXTRINSIC_INDEX};
use codec::Decode;
    ...
    pub fn commit_prospective(&mut self) {
        if self.committed.is_empty() {
            ...
            for (storage_key, map) in self.prospective.children.drain() {
                ...
                entry
                    .1
                    .extend(map.1.iter().map(|(k, v)| (k.clone(), v.clone())));
...
mod tests {
    ...
    fn strip_extrinsic_index(
        map: &HashMap<Vec<u8>, OverlayedValue>,
    ...
    fn overlayed_storage_root_works() {
        ...
        const ROOT: [u8; 32] =
            hex!("0b41e488cccbd67d1f1089592c2c235f5c5399b053f7fe9152dd4b5f279914cd");
