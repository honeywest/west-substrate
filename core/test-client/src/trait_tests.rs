    ...
    B: backend::LocalBackend<runtime::Block, Blake2Hasher>,
{
    ...
    assert_eq!(backend.blockchain().leaves().unwrap(), vec![a1.hash()]);
    ...
    assert_eq!(backend.blockchain().leaves().unwrap(), vec![a3.hash()]);
    ...
    assert_eq!(backend.blockchain().leaves().unwrap(), vec![a4.hash()]);
    ...
    assert_eq!(backend.blockchain().leaves().unwrap(), vec![a5.hash()]);
    ...
    B: backend::LocalBackend<runtime::Block, Blake2Hasher>,
{
    ...
    assert_eq!(
        client.backend().blockchain().hash(0).unwrap().unwrap(),
        genesis_hash
    );
    ...
    assert_eq!(
        client.backend().blockchain().hash(1).unwrap().unwrap(),
        a1.hash()
    );
    ...
    assert_eq!(
        client.backend().blockchain().hash(2).unwrap().unwrap(),
        a2.hash()
    );
    ...
    assert_eq!(
        client.backend().blockchain().hash(3).unwrap().unwrap(),
        a3.hash()
    );
    ...
    assert_eq!(
        client.backend().blockchain().hash(4).unwrap().unwrap(),
        a4.hash()
    );
    ...
    assert_eq!(
        client.backend().blockchain().hash(5).unwrap().unwrap(),
        a5.hash()
    );
}
